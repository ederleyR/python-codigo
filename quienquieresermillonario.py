...
comodines = {1:["1.llama a un amigo"],
             ...
             4:["4.NO"]}
ganar= 0
print("profesor cuando valla a seleccionar la pregunta correcta coloca LITERALMENTE todo ejemplo B. Naranja si no no funciona y con los comodines/retirarse con un numero basta ni mas ni menos ")
        ...
        case 2:
                ...
                match comodin:
                    ...
                    case 3:
                        ...
                        match comodin:
                            case 1:
                                respuesta_Aleatoria = random.choice([pregunta_aletoria, preguntas[nivel][1]["respuesta"]])
                                print("juan: hola amigo yo digo que elijas",respuesta_Aleatoria)
                                pregunta1 = input("cual es la correcta: ")
                                if pregunta1 == preguntas[nivel][1]["respuesta"]:
                                    print("correcto")
                ...
                match comodin:
                    case 4:
                        ...
                        if pregunta == preguntas[nivel][0]["respuesta"]:
                            ...
                            break
                    case 1:
                        respuesta_Aleatoria = random.choice([pregunta_aletoria, preguntas[nivel][0]["respuesta"]])
                        print("juan: hola amigo yo digo que elijas",respuesta_Aleatoria)
                        del comodines[1]
                        print(comodines)
                        comodin = int(input("quieres usar otro comodin?: "))
